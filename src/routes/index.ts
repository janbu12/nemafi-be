...
import { appSettingRouter } from './appSettingRoutes.js';
import { integrationTestRouter } from './integrationTestRoutes.js';
...
router.use('/integration-tests', integrationTestRouter);
